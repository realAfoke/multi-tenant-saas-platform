export default function Footer() {
	return (
		<>
			<footer className="text-[14px] md:text-[12px] text-gray-300 bg-inherit pt-15 pb-2 px-5 antialiased">
				<div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] border-b border-gray-100/30 pb-5">
					...
					<div>
						...
						<div className="flex flex-col gap-3">
							...
							/>
							<button className="p-5 py-3 font-semibold bg-blue-400 md:py-2 md:px-2 md:text-[10px] text-white text-center rounded-md outline-none border-none">
								Subscribe Now
							</button>
						</div>
