...
export default function SideBar(props) {
	...
	return (
		<div ref={ref} className={` border-4 relative overflow-auto min-h-screen scrollbar scrollbar-thin scrollbar-thumb-zinc-600 scrollbar-track-zinc-900 text-white bg-[#131011] shadow-lg border-r border-[#f6f3f438] px-2 min-w-60 md:relative md:min-w-[20rem] `}>
