...
import { dateFormatter, convertObjKeys } from "@/utils/appUtil"
	...
	return (
		<div className="space-y-10">
			...
			<div className={`flex-col gap-5 `}>
				...
				{showMoreMembers &&
					<div ref={ref} className="min-w-[calc(100%-65%)] md:min-w-[calc(100%-75%)] bg-zinc-900/50 pt-5 fixed top-10 backdrop-blur-sm h-screen overflow-auto right-0">
